...
| Bauausführung | Construction-execution parser and Obra adapter DTO readiness evidence. | `docs/fixtures/bvbs-bau-x83-readiness.md`, `gaeb/golden/bvbs_bau/`, Bau X83/X84 tests. | `supported_parse_only` readiness may include `adapt_to_obra`; no schema validation, export, roundtrip, paid submission, or certification promotion. |
