...
# PRD PHASE-21: STABU / RAW exchange model

## Problem
Obra needs full, honest BoQ coverage through boq-core and the boq-service boundary. This phase solves one independently deliverable slice: Define Dutch STABU/RAW exchange model boundaries and synthetic adapter contracts.
