...
# PRD PHASE-22: DQE French quantity estimate model

## Problem
Obra needs full, honest BoQ coverage through boq-core and the boq-service boundary. This phase solves one independently deliverable slice: Define DQE quantity-estimate model and adapter contract with support honesty.
