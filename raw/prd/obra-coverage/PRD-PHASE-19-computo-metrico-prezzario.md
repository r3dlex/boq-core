...
# PRD PHASE-19: Computo Metrico and Prezzario model

## Problem
Obra needs full, honest BoQ coverage through boq-core and the boq-service boundary. This phase solves one independently deliverable slice: Add Italian quantity/price-list model seams and loss reporting without external regional data acquisition.
