...
| R2-01 | Rank 2 | #32 | Official invoicing schema package | manifested | official_gaeb_xml33_rechnung | reference_only |
| R2-02 | Rank 2 | #32 | Interactive X89 schema | artifact-only/reference | — | reference_only |
| R2-03 | Rank 2 | #32 | Interactive X89B schema | artifact-only/reference | — | reference_only |
| R2-04 | Rank 2 | #32 | BVBS E-Rechnung implementation recommendation | artifact-only/reference | — | reference_only |
| R2-05 | Rank 2 | #32 | MWM-Mengen-Viewer utility | artifact-only/reference | — | reference_only |
| R3-01 | Rank 3 | #33 | GAEB DA XML 3.2 technical documentation | artifact-only/reference | — | reference_only |
| R3-02 | Rank 3 | #33 | GAEB DA XML 3.2 LV core package | manifested | official_gaeb_xml32_leistungsverzeichnis | reference_only |
| R3-03 | Rank 3 | #33 | Interactive GAEB XML 3.2 X83 schema | artifact-only/reference | — | reference_only |
| R3-04 | Rank 3 | #33 | BVBS XML 3.2 AVA X81 | manifested | bvbs_xml32_ava_x81 | future_track:`future_legacy_xml32_ava_x81_cataloged` |
| R3-05 | Rank 3 | #33 | BVBS XML 3.2 AVA X84 | manifested | bvbs_xml32_ava_x84 | future_track:`future_legacy_xml32_ava_x84_cataloged` |
| R3-06 | Rank 3 | #33 | BVBS XML 3.2 AVA X86 | manifested | bvbs_xml32_ava_x86 | future_track:`future_legacy_xml32_ava_x86_cataloged` |
| R3-07 | Rank 3 | #33 | Muster-LV visual PDF AVA 3.2 | artifact-only/reference | — | reference_only |
| R3-08 | Rank 3 | #33 | BVBS AVA 3.2 criteria PDF | artifact-only/reference | — | reference_only |
| R3-09 | Rank 3 | #33 | GAEB DA XML 3.1 technical documentation | artifact-only/reference | — | reference_only |
| R3-10 | Rank 3 | #33 | GAEB 3.1 sample datasets | manifested | official_gaeb_xml31_muster_2009_12 | reference_only |
| R3-11 | Rank 3 | #33 | Interactive GAEB XML 3.1 schema directory | artifact-only/reference | — | reference_only |
| R3-12 | Rank 3 | #33 | BVBS 3.1 Bauausführung X83 | manifested | bvbs_xml31_bau_x83 | future_track:`test_xml31_bau_sources_are_cataloged_before_parser_promotion` |
