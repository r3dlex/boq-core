...
This PRD is bound to the canonical ranked roadmap ledger in `.omx/specs/gaeb-ranked-source-status-ledger.md`. Issue #39 owns the following source rows for planning and test-readiness purposes:
